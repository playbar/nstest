...
{
	int ilen = 0;
   png_byte png_signature[8] = {0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a };
   if (num_to_check > 8)
      num_to_check = 8;
   ...
   ilen = ((int)(png_memcmp(&sig[start], &png_signature[start], num_to_check)));
   //int res = memcmp(&sig[start], &png_signature[start], num_to_check );
