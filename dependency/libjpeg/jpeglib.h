...
//Add by xiepeifu
//EXTERN(void) jpeg_stdio_buffer_dest JPP((j_compress_ptr cinfo,void*inst,));
EXTERN(void) jpeg_stdio_src JPP((j_decompress_ptr cinfo, FILE * infile));
EXTERN(void) jpeg_stdio_buffer_src JPP((j_decompress_ptr cinfo, UINT8 * buffer, size_t size));
