...
#ifdef _DEBUG
#define FLASHASSERT(VV) //{if(!(VV)) _FlashDebug();}
extern void _FlashDebug();
#else
...
#define XROUND(VV) ((int)(VV>=0?VV+0.5:VV-0.5))
//
...
#ifndef __APPLE__	// modified by handong
	#define BIG_ENDIAN
#endif
...
#define XMAXARRAY 0xffffff
#define XSWFTRIP 20
#define double_PI	3.141592653589793
#define XFDOUBLE double
