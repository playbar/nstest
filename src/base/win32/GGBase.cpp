...
//////////////////////////////////////////////////////////////////////
static ULONG_PTR m_gdiplusToken=XNULL;

static XPCTSTR _strIcons[XMAX_ICONS]=
{
	("LOADING"),("FAILED"),("CONNECT"),
	("HOME"),("ANI"),("MAINICON"),"GREENBLOCK",
	"BLUEBLOCK","GRAYBLOCK","BUTTON", "PAGELOADING" 
};
