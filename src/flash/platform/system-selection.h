...
#ifdef __ANDROID__
  #define AVMSYSTEM_ANDROID 1
#else
  #define AVMSYSTEM_ANDROID 0
#endif
...
#if AVMSYSTEM_MAC || AVMSYSTEM_UNIX  || AVMSYSTEM_ANDROID
...
// endianness
  ...
  #define AVMSYSTEM_BIG_ENDIAN          0
	...
	//be changed by zhangchen
	//the new symbian platform isn't as same as symbian platform 4 years ago
	#elif AVMSYSTEM_SYMBIAN && AVMSYSTEM_ARM
		#include <machine/endian.h>
        #define __BYTE_ORDER BYTE_ORDER
    #else 
		#include <endian.h>
