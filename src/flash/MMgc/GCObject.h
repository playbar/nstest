...
namespace MMgc
{
	...
	public:
		GCWeakRef *GetWeakRef() const;
		virtual bool AddCallBack(void*,void*){return false;}
		virtual bool RemoveCallBack(void*,void*){return false;}
		virtual void CallBack(void*){}		
		virtual void Release(){}
#ifdef _ANALY
		virtual void Report(XSortMemName*pInfo){};
		virtual char* GetName(){return (char*)0;}//char*name=new char[9];memcpy(name,"GCObject",9);return name;}
#endif
