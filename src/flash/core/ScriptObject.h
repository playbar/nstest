...
namespace avmplus
{
	...
	public:
		...
		Stringp formatToString(Stringp strsp,Stringp streq,Stringp strqt,Stringp strName,ArrayObject*pArgs);
		Stringp formatString(Stringp strSpace,Stringp strEqual,Stringp strQt,bool noObject=true,bool noName=false,bool justVar=false);
		...
		Atom getSlotAtom(uint32_t slot,Traits*traits=NULL);
