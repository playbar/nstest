...
namespace avmplus
{
	...
	{
		//if(vtable->traits
		//Stringp nsString=NULL;
		//if(vtable->traits->ns())
		//	nsString=vtable->traits->ns()->getURI();
        switch (AvmCore::bindingKind(b))
        {
		case BKIND_METHOD: 
		{
...
# ifdef DEBUGGER
	...
	DateClass* Toplevel::dateClass(bool bCreate) { return (DateClass*)getBuiltinClass(avmplus::NativeID::abcclass_Date,bCreate); }
	RegExpClass* Toplevel::regexpClass( ) { return (RegExpClass*)getBuiltinClass(avmplus::NativeID::abcclass_RegExp); }
	XMLClass* Toplevel::xmlClass(bool bCreate) { return (XMLClass*)getBuiltinClass(avmplus::NativeID::abcclass_XML,bCreate); }
	...
	// virtual
	ClassClosure *Toplevel::getBuiltinExtensionClass(int /*clsid*/,bool)
	{
		return NULL;
	}
	...
	//dsx new adds
	//UIntVectorClass* Toplevel::GetuintVectorClass() const {return (UIntVectorClass*)getBuiltinClass(avmplus::NativeID::abcclass___AS3___vec_Vector_uint);}
	//IntVectorClass* Toplevel::GetintVectorClass() const {return (IntVectorClass*)getBuiltinClass(avmplus::NativeID::abcclass___AS3___vec_Vector_int);}
	//DoubleVectorClass* Toplevel::GetdoubleVectorClass() const {return (DoubleVectorClass*)getBuiltinClass(avmplus::NativeID::abcclass___AS3___vec_Vector_double);}
	//ObjectVectorClass* Toplevel::GetobjectVectorClass() const {return (ObjectVectorClass*)getBuiltinClass(avmplus::NativeID::abcclass___AS3___vec_Vector_object);}
	//VectorClass* Toplevel::GetvectorClass() const {return (VectorClass*)getBuiltinClass(avmplus::NativeID::abcclass___AS3___vec_Vector);}
	//dsx new adds end
}
