...
#ifndef __avmfeatures_h__   //add by hgl
#define __avmfeatures_h__
...
#if AVMSYSTEM_UNIX+AVMSYSTEM_MAC+AVMSYSTEM_WIN32+AVMSYSTEM_SYMBIAN + AVMSYSTEM_ANDROID != 1
