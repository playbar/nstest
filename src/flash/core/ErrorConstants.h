...
{ 
    namespace ErrorConstants
    {
        ...
        enum
        {
			...
			kArgumentErrorExt1								= 2004,
			kArgumentErrorExt2								= 2006,
			kArgumentErrorExt3								= 2007,
			kArgumentErrorExt4								= 2008,
			kArgumentErrorExt5								= 2012,
			kArgumentErrorExt6								= 2057,
			kIllegalOptionError								= 2069,
			kArgumentErrorExt7								= 2181,
        };
