...
namespace avmplus
{
	...
	public:
		...
		//[Note X]
		WeakKeyHashtable *getMethodClosureTableRef();
	...
	public:
		...
		//inline MethodEnv* getOverMethodEnv(){return overMethod;}
		//inline void setOverMethodEnv(MethodEnv*env){overMethod=env;}
		//bool isOverwrite();
		//void setOverwrite(bool bOver=true);
	...
	private:
		...
		//[Note X] for weakRefrence
		uintptr_t					activationOrMCTableRef;	
	public:
