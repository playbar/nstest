...
namespace avmplus
{
	...
	public:
		...
		DateClass* dateClass(bool bCreate=true);
		RegExpClass* regexpClass();
		XMLClass* xmlClass(bool bCreate=true);
		...
		//dsx new adds
		//UIntVectorClass* GetuintVectorClass() const;
		//IntVectorClass* GetintVectorClass() const;
		//DoubleVectorClass* GetdoubleVectorClass() const;
		//ObjectVectorClass* GetobjectVectorClass() const;
		//VectorClass* GetvectorClass() const;
		//dsx new adds end
	...
	public:
        ...
        ClassClosure* getBuiltinClass(int class_id,bool bCreate=true) const;
		...
		virtual ClassClosure *getBuiltinExtensionClass(int clsid,bool bCreate=true);
