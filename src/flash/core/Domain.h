...
#ifndef __avmplus_bytearray__
#define __avmplus_bytearray__
...
namespace avmplus
{
	...
	public:
		...
		void SetOverWrite(bool bOver){m_bOverWrite=bOver;}
		bool IsOverWrite(){return m_bOverWrite;}

		Domain* getNamedTraitsDomain(Stringp name,Namespacep);
		Domain* getNamedScriptDomain(Stringp name,Namespacep);
