...
namespace avmplus
{
...
#elif _WINEMU64
	const _int64 atomMinIntValue = -((_int64)1<<53);
    const _int64 atomMaxIntValue = ((_int64)1<<53)-1;
#else
...
#ifdef _WINEMU64
    _int64        atomGetIntptr(Atom atom);
    ...
    bool            atomIsValidIntptrValue(const _int64 i);
    ...
    bool            atomIsValidIntptrValue_u(const unsigned _int64 u);
#else
