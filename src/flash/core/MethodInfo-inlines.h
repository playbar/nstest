...
#ifndef __MethodInfo_inlines_H__  // add by hgl 
#define __MethodInfo_inlines_H__
...
/*REALLY_INLINE int32_t MethodInfo::isOverwrite() const
{
    return _flags & OVERWRITECLASS;
}

REALLY_INLINE void MethodInfo::setOverwrite()
{
    _flags |= OVERWRITECLASS;
}*/
...
REALLY_INLINE bool MethodInfo::isOverride()
{
    return (_flags & OVERRIDE)!=0;
}
...
#endif //__MethodInfo-inlines_H__
