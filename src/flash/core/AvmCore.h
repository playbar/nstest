...
const int kBufferPadding = 16;
	...
	public:
		...
		bool m_bBreakOutTime;
#endif
		void addLivePool(PoolObject* pool);
		void ReleaseIntern(uint8_t*buffer,int l);
	public:
		/**
	...
	public:
		 ...
		 */
		virtual void ExportClass(Stringp name)=0;
...
# endif
		...
		virtual bool InitClassClosure(ClassClosure*c)=0;
