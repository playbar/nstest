...
namespace avmplus
{
	class DomainEnv : public MMgc::GCObject
	{
	  public:
		...
		MethodEnv* getScriptEntry(const Multiname& multiname) const;
		...
		//[Note X]
		inline void setOverwrite(bool bOver){m_bOverwrite=bOver;}
		inline bool isOverwrite(){return m_bOverwrite;}
		//inline void SetTopSeek(bool bTop){m_bTopSeek=bTop;}
		/**
