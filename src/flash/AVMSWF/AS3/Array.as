...
//	[native(cls="ArrayClass", instance="ArrayObject", methods="auto")]
	[native(cls="ArrayClass", methods="auto")]
	public dynamic class Array extends Object
	{
		...
		*/
		 native function push(...args):uint
		...
		private static native function _slice(o, A:Number, B:Number):Array
		 function slice(A=0, B=0xffffffff):Array
		{
		...
		*/
		...
		native  function unshift(...args):uint
		...
		private static native function _sortOn(o, names, options)
		 function sortOn(names, options=0, ...ignored)
		{
		...
		private static native function _lastIndexOf (o, searchElement, fromIndex:int=0):int;
		 function lastIndexOf(searchElement, fromIndex=0x7fffffff):int
		{
