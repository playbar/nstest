...
package flash.geom
{
	[native(cls="TransformClass", methods="auto")]
	...
	public class Transform
	{
		//Properties
		 ...
		 public native function set colorTransform(newColorTransform : ColorTransform): void
		 ...
		 public native function set matrix(newMatrix : Matrix): void

		 public native function get pixelBounds() : Rectangle 

		//new adds
		public native function get matrix3D() : Matrix3D
		public native function set matrix3D(matrix3D : Matrix3D)

		public native function get perspectiveProjection() : PerspectiveProjection
		public native function set perspectiveProjection(perspectiveProjection : PerspectiveProjection):void
		//new adds end
