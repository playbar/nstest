 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 package flash.geom
 {
 	...
 	{
 		//Properties
 		public var alphaMultiplier : Number = 1;//与 Alpha 透明度通道值相乘的十进制值。 ColorTransform 
		public var alphaOffset : Number=0;//-255 到 255 之间的数字，它先与 alphaMultiplier 值相乘，再与 Alpha 透明度通道值相加。 ColorTransform 
		public var blueMultiplier : Number =1;//与蓝色通道值相乘的十进制值。 ColorTransform 
		public var blueOffset : Number = 0;//-255 到 255 之间的数字，它先与 blueMultiplier 值相乘，再与蓝色通道值相加。 ColorTransform 
		public var greenMultiplier : Number = 1;//与绿色通道值相乘的十进制值。 ColorTransform 
		public var greenOffset : Number = 0;//-255 到 255 之间的数字，它先与 greenMultiplier 值相乘，再与绿色通道值相加。 ColorTransform 
		public var redMultiplier : Number = 1;//与红色通道值相乘的十进制值。 ColorTransform 
