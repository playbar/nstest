 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 package flash.net
 {
 	[native(cls="LocalConnectionClass", methods="auto")]
	...
	import flash.events.EventDispatcher
 	...
 	public class LocalConnection extends  EventDispatcher
 	{
		...
		public native function set isPerUser(isPerUser : Boolean):void
		...
		public static function get isSupported() : Boolean
		{
 		...
 		//Methods
 		 ...
 		 public native function allowDomainN(domains:Array):void 
 		 public function allowInsecureDomain(... domains):void 
 		 {
 			allowInsecureDomainN(domains);
 		 }
 		 public native function allowInsecureDomainN(domains:Array):void 
 		 public native function close():void 
 		 public native function connect(connectionName:String):void 
 		 public native function nativeSend(connectionName:String, methodName:String,arguments:Array):void 
 		 public function send(connectionName:String, methodName:String, ... arguments):void 
 		 {
 			nativeSend(connectionName,methodName,arguments);
 		 }
 	}
 }
