 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 package flash.net
 {
 	[native(cls="URLLoaderClass", methods="auto")]
	...
	import flash.net.URLRequest
 	...
 	public class URLLoader extends  EventDispatcher
 	{
		 ...
		 public native function set bytesLoaded(newBytesLoaded : uint): void

		 public native function get bytesTotal() : uint
		 public native function set bytesTotal(newBytesTotal : uint): void

		 public native function get data() : * 
		 public native function set data(newData : *): void

		 public native function get dataFormat() : String
		 public native function set dataFormat(newDataFormat : String): void
