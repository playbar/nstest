 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 {
 	[native(cls="ContextMenuEventClass", methods="auto")]
	...
	import flash.display.InteractiveObject
 	...
 	public class ContextMenuEvent extends  Event
 	{
		 ...
		 public native function set contextMenuOwner(newContextMenuOwner : InteractiveObject): void

		 public native function get mouseTarget() : InteractiveObject
		 public native function set mouseTarget(newmouseTarget : InteractiveObject): void

		 //new adds
		 public native function get isMouseTargetInaccessible() : Boolean
		 public native function set isMouseTargetInaccessible(isMouseTargetInaccessible : Boolean):void
		 //new adds end
		...
		//Methods
		 ...
		 /*{
 			var s:String="[ContextMenuEvent type=\"";
 			s+=type;
 			s+="\" bubbles=";
 			s+=String(bubbles);
 			s+=" cancelable=";
 			...
 			s+=String(eventPhase);
 			s+=" mouseTarget=";
 			s+=String(mouseTarget);
 			s+=" contextMenuOwner=";
 			s+=String(contextMenuOwner);
 			s+="]";
		 }*/
 	}
 }
