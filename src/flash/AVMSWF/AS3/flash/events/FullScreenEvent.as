 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 {
 	[native(cls="FullScreenEventClass", methods="auto")]
	...
	import flash.events.ActivityEvent
 	...
 	public class FullScreenEvent extends  ActivityEvent
 	{
 		...
 		//new adds 11
 		public native function get interactive():Boolean
 		//new adds 11 end

 		//Methods
 		 public native function FullScreenEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, fullScreen:Boolean = false, interactive:Boolean = false) 
