 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 {
 	[native(cls="FocusEventClass", methods="auto")]
	...
	import flash.display.InteractiveObject
 	...
 	public class FocusEvent extends  Event
 	{
		 ...
		 public native function set direction(direction : String):void
 		...
 		//Methods
 		 public native function FocusEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false, relatedObject:InteractiveObject = null, shiftKey:Boolean = false, keyCode:uint = 0)

 		 public native override function clone():Event
 		 public native override function toString():String 
		 /*{
 			var s:String="[FocusEvent type=\"";
 			s+=type;
 			s+="\" bubbles=";
 			s+=String(bubbles);
 			s+=" cancelable=";
