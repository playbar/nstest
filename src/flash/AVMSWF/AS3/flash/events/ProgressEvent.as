...
{
	[native(cls="ProgressEventClass", methods="auto")]
	...
	public class ProgressEvent extends  Event
	{
		...
		//Methods
		 public native function ProgressEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, bytesLoaded:uint = 0, bytesTotal:uint = 0) 
