 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 {
 	[native(cls="IMEEventClass", methods="auto")]
	...
	import flash.text.ime.IIMEClient
 	...
 	public class IMEEvent extends  TextEvent
 	{
		...
		public native function set imeClient(imeClient : IIMEClient):void
		//new adds end

 		//Methods
 		 public native function IMEEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, text:String = "") 
