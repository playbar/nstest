 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 {
 	[native(cls="DataEventClass", methods="auto")]
	...
	import flash.events.TextEvent
 	...
 	public class DataEvent extends  TextEvent
 	{
		 ...
		 public native function set data(newData : String): void

 		//Methods
 		 public native function DataEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, data:String = "")
