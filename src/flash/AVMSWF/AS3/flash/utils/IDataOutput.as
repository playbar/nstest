 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 package flash.utils
 {
 	[native(cls="IDataOutputClass", methods="auto")]
 	...
 	public interface IDataOutput
 	{
		 ...
		 function set endian(newEndian : String): void

		 function get objectEncoding() : uint 
		 function set objectEncoding(newObjectEncoding : uint): void
 		...
 		//Methods
 		 ...
 		 function writeObject(value):void 
