 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 package flash.text
 {
 	[native(cls="FontClass", methods="auto")]
 	...
 	public class Font
 	{
		...
		//Methods
		 public native static function enumerateFonts(enumerateDeviceFonts:Boolean = false):Array 

		 public native function hasGlyphs(str:String):Boolean 
		 public native static function registerFont(font:Class):void 
 	}
 }