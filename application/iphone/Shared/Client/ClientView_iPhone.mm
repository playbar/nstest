...
@implementation ClientView_iPhone
@synthesize lastPoint;
@synthesize mouseShowEnable;

XString8 g_documentDirPath_iPhone;
XString8 g_bundlePath_iPhone;
...
- (void)layoutSubviews
{
    ...
    XRect xrect;
    CGRect viewBounds = [self bounds];
//    [m_viewController viewResize:viewBounds];
...
//- (void)mouseShow:(BOOL)enabled
//{
//    mouseShowEnable = enabled;
//    
//    // 检查下，如果aImageView当前正在显示，则隐藏掉
//    if (![aImageView isHidden])
//    {
//        [aImageView setHidden:YES];
//    }
//    
...
//    if ([eventTouches count]==1)
//    {
//        startPoint = [[eventTouches objectAtIndex:0] locationInView:self];
//    }
...
//- (void)savePointState
//{
//    NSURL* plistURL = [[NSBundle mainBundle] URLForResource:@"default" withExtension:@"plist"];
//    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfURL:plistURL];
//    [dictionary setValue:[NSNumber numberWithBool:mouseShowEnable] forKey:@"pointState"];
//    [dictionary writeToURL:plistURL atomically:YES];
//}
//
//- (void)loadPointState
//{
//    NSURL* plistURL = [[NSBundle mainBundle] URLForResource:@"default" withExtension:@"plist"];
//    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfURL:plistURL];
//    mouseShowEnable = [[dictionary valueForKey:@"pointState"] boolValue];
//}
