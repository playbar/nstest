...
@interface inputViewController_iPhone()
...
- (void)viewDidLoad 
{
    ...
    historyViewController = [[historyViewController_iPhone alloc] initWithNibName:@"historyViewController_iPhone" bundle:nil];
...
- (void)showKeyBoard
{
    ...
    if(g_explorerController_iPhone)
    {
        m_iLastPoint = g_explorerController_iPhone.clientView.lastPoint;
    }
