#ifndef TABSECOND_GROUPTWO_DIALOG_H
#define TABSECOND_GROUPTWO_DIALOG_H
...
class TabSecond_GroupTwo_Dialog : public QDialog
{
    Q_OBJECT

public:
    TabSecond_GroupTwo_Dialog(QWidget* parent = NULL);
...
#endif // TABSECOND_GROUPTWO_DIALOG_H
